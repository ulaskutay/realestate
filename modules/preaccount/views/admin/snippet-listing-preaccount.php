...
<div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 mt-6">
    ...
    <?php if (empty($transactions)): ?>
        <p class="text-sm text-gray-500 dark:text-gray-400">Bu ilan için henüz hareket yok.</p>
    <?php else: ?>
        ...
        <p class="mt-2 text-xs text-gray-500"><a href="<?php echo admin_url('module/preaccount/transactions'); ?>" class="text-primary hover:underline">Tümünü gör</a></p>
    <?php endif; ?>
</div>
