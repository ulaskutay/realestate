    ...
    <style>
        * {
        ...
        .step-line {
            ...
            right: 25%;
            height: 3px;
            background: linear-gradient(to right, #10b981 0%, #10b981 50%, #e2e8f0 50%);
            z-index: 1;
            border-radius: 2px;
        }
        h1 {
...
<body>
    <div class="install-container">
        ...
        <h1>Site Yapılandırması</h1>
        <p class="subtitle">Site adınızı ve yönetici bilgilerinizi belirleyin</p>
