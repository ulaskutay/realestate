            ...
            <div class="layout-content-container flex flex-col w-full mx-auto max-w-6xl">
                ...
                <header class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <?php endif; ?>
                        <a href="<?php echo admin_url('pages/versions/' . $page['id']); ?>" class="flex items-center gap-2 px-4 py-2 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                ...
                <form action="<?php echo admin_url('pages/update/' . $page['id']); ?>" method="POST" id="page-form">
