...
<!-- Hero Section -->
<?php if ($heroEnabled ?? true): ?>
<section class="relative py-20 lg:py-28 bg-gradient-to-br from-blue-600 via-indigo-700 to-blue-800 text-white overflow-hidden">
    <!-- Background Pattern -->
    ...
    <div class="container mx-auto px-4 lg:px-6 relative z-10">
        <div class="max-w-4xl mx-auto text-center">
            <h1 class="text-4xl lg:text-6xl font-bold mb-6 leading-tight text-white">
                <?php echo esc_html($heroTitle ?? __('Hayalinizdeki Mülkü Bulalım')); ?>
            </h1>
            <p class="text-xl lg:text-2xl text-white/90 mb-8 leading-relaxed">
                <?php echo esc_html($heroSubtitle ?? __('Uzman ekibimiz, mülk satın alma, satış veya kiralama işlemlerinizde size yardımcı olmak için burada. Hemen iletişime geçin!')); ?>
            </p>
            ...
            <div class="flex flex-wrap justify-center gap-6 lg:gap-8 mt-10">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-lg font-medium text-white"><?php echo esc_html(__('24 Saat İçinde Yanıt')); ?></span>
                </div>
                <div class="flex items-center gap-3">
                    <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-lg font-medium text-white"><?php echo esc_html(__('500+ Mülk Seçeneği')); ?></span>
                </div>
                <div class="flex items-center gap-3">
                    <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-lg font-medium text-white"><?php echo esc_html(__('Uzman Danışmanlar')); ?></span>
                </div>
                <div class="flex items-center gap-3">
                    <div class="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-lg font-medium text-white"><?php echo esc_html(__('Güvenli İşlem')); ?></span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 lg:p-10">
                <div class="mb-8">
                    ...
                    <h2 class="text-3xl font-bold text-secondary mb-3">
                        <?php echo esc_html($formTitle ?? __('Mülk Talebinizi İletin')); ?>
                    </h2>
                    <p class="text-gray-600 text-lg">
                        <?php echo esc_html($formDescription ?? __('Aradığınız mülk özelliklerini belirtin, size en uygun seçenekleri sunalım.')); ?>
                    </p>
                </div>
                ...
                <?php 
                // Form render - customize'den seçilen form slug'ı ile formu göster
                $formSlugToShow = $formSlug ?? 'iletisim';
                if (function_exists('the_form')) {
                    the_form($formSlugToShow);
                } else if (function_exists('cms_form')) {
                    echo cms_form($formSlugToShow);
                } else {
                    echo '<p class="text-gray-600">İletişim formu yüklenemedi.</p>';
                }
                ?>
                
                <?php if ($whyChooseEnabled && !empty($whyChooseItems)): ?>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            <h4 class="text-lg font-bold text-gray-900 mb-2">
                                <?php echo esc_html($whyChooseTitle); ?>
                            </h4>
                ...
                <div class="bg-white rounded-xl p-6 shadow-lg">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <?php foreach ($servicesItems as $service): ?>
                            ...
                            ?>
                            <a href="<?php echo esc_url($serviceLink); ?>" class="p-4 bg-gray-50 rounded-lg text-center hover:bg-primary/5 transition-colors block">
                                <span class="material-symbols-outlined text-3xl text-primary mx-auto mb-2 block"><?php echo esc_html($serviceIcon); ?></span>
                                <p class="text-xs font-semibold text-gray-700"><?php echo esc_html($service['title']); ?></p>
                            </a>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </div>
...
<!-- Map Section -->
<?php if (($mapEnabled ?? true) && ($mapEmbed || $companyAddress)): ?>
