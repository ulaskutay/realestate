        ...
        <div class="flex-1 flex flex-col lg:ml-64">
            ...
            <div class="layout-content-container flex flex-col w-full mx-auto max-w-7xl">
                ...
                <header class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    ...
                    <a href="<?php echo admin_url('module/pages/create'); ?>" class="flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors">
                ...
                <section class="rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-800 overflow-hidden">
                    ...
                    <div class="p-12 text-center">
                        ...
                        <a href="<?php echo admin_url('module/pages/create'); ?>" class="inline-flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90">
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <a href="<?php echo admin_url('module/pages/restore/' . $page['id']); ?>" class="p-2 text-gray-600 hover:text-green-600 hover:bg-green-50 dark:hover:bg-green-900/20 rounded-lg" title="Geri Yükle">
                                                <span class="material-symbols-outlined text-xl">restore</span>
                                            </a>
                                            <?php else: ?>
                                            <a href="<?php echo admin_url('module/pages/edit/' . $page['id']); ?>" class="p-2 text-gray-600 hover:text-primary hover:bg-primary/10 rounded-lg" title="Düzenle">
                                                <span class="material-symbols-outlined text-xl">edit</span>
                                            </a>
                                            <a href="<?php echo admin_url('module/pages/duplicate/' . $page['id']); ?>" class="p-2 text-gray-600 hover:text-primary hover:bg-primary/10 rounded-lg" title="Sayfayı Kopyala">
                                                <span class="material-symbols-outlined text-xl">content_copy</span>
                                            </a>
                                            <a href="<?php echo admin_url('module/pages/toggle/' . $page['id']); ?>" class="p-2 text-gray-600 hover:text-primary hover:bg-primary/10 rounded-lg" title="<?php echo $page['status'] === 'published' ? 'Taslağa Al' : 'Yayınla'; ?>">
                                                <span class="material-symbols-outlined text-xl"><?php echo $page['status'] === 'published' ? 'unpublished' : 'publish'; ?></span>
                                            </a>
                                            <?php endif; ?>
                                            <a href="<?php echo admin_url('module/pages/delete/' . $page['id']); ?>" class="p-2 text-gray-600 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg" onclick="return confirm('<?php echo $page['status'] === 'trash' ? 'Kalıcı olarak silmek istediğinize emin misiniz?' : 'Çöpe taşımak istediğinize emin misiniz?'; ?>');" title="<?php echo $page['status'] === 'trash' ? 'Kalıcı Sil' : 'Çöpe Taşı'; ?>">
                    ...
                    <div class="md:hidden space-y-4 p-4">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-white/10 p-4">
                            ...
                            <div class="flex items-center justify-end gap-2 pt-3 border-t border-gray-200 dark:border-white/10">
                                <?php if ($page['status'] === 'trash'): ?>
                                <a href="<?php echo admin_url('module/pages/restore/' . $page['id']); ?>" class="flex-1 flex items-center justify-center gap-1 px-3 py-2 text-sm text-green-600 hover:bg-green-50 dark:hover:bg-green-900/20 rounded-lg transition-colors">
                                    <span class="material-symbols-outlined text-lg">restore</span>
                                    <span>Geri Yükle</span>
                                </a>
                                <?php else: ?>
                                <a href="<?php echo admin_url('module/pages/edit/' . $page['id']); ?>" class="flex-1 flex items-center justify-center gap-1 px-3 py-2 text-sm text-primary hover:bg-primary/10 rounded-lg transition-colors">
                                    <span class="material-symbols-outlined text-lg">edit</span>
                                    <span>Düzenle</span>
                                </a>
                                <a href="<?php echo admin_url('module/pages/duplicate/' . $page['id']); ?>" class="px-3 py-2 text-sm text-gray-600 hover:text-primary hover:bg-primary/10 rounded-lg transition-colors" title="Sayfayı Kopyala">
                                    <span class="material-symbols-outlined text-lg">content_copy</span>
                                </a>
                                <a href="<?php echo admin_url('module/pages/toggle/' . $page['id']); ?>" class="px-3 py-2 text-sm text-gray-600 hover:text-primary hover:bg-primary/10 rounded-lg transition-colors" title="<?php echo $page['status'] === 'published' ? 'Taslağa Al' : 'Yayınla'; ?>">
                                    <span class="material-symbols-outlined text-lg"><?php echo $page['status'] === 'published' ? 'unpublished' : 'publish'; ?></span>
                                </a>
                                <?php endif; ?>
                                <a href="<?php echo admin_url('module/pages/delete/' . $page['id']); ?>" class="px-3 py-2 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors" onclick="return confirm('<?php echo $page['status'] === 'trash' ? 'Kalıcı olarak silmek istediğinize emin misiniz?' : 'Çöpe taşımak istediğinize emin misiniz?'; ?>');" title="<?php echo $page['status'] === 'trash' ? 'Kalıcı Sil' : 'Çöpe Taşı'; ?>">
