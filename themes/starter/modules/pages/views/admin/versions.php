                ...
                <header class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    <div class="flex flex-col gap-2">
                        <div class="flex items-center gap-2">
                            <a href="<?php echo admin_url('module/pages/edit/' . $page['id']); ?>" class="text-gray-500 hover:text-primary transition-colors">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="<?php echo admin_url('module/pages/edit/' . $page['id']); ?>" class="flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors">
                    ...
                    <div class="rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-800 overflow-hidden">
                        <div class="p-4 flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <a href="<?php echo admin_url('module/pages/restore-version/' . $version['id']); ?>" 
