...
<head>
    ...
    $pageTitle = $title ?? ($seoTitle ?: 'Codetic Theme');
    ?>
    ...
    $defaultMetaDesc = 'Modern, profesyonel ve performanslı web çözümleri. Codetic ile dijital dönüşümünüzü başlatın.';
    ...
    <style>
        :root {
            --color-primary: <?php echo $themeLoader ? $themeLoader->getColor('primary', '#3b82f6') : '#3b82f6'; ?>;
            --color-secondary: <?php echo $themeLoader ? $themeLoader->getColor('secondary', '#8b5cf6') : '#8b5cf6'; ?>;
...
<body class="antialiased">
    ...
    <button id="back-to-top" class="fixed bottom-6 right-6 p-3 bg-gradient-to-r from-primary to-secondary text-white rounded-full shadow-lg shadow-primary/25 opacity-0 invisible transition-all duration-300 hover:scale-110 z-50">
